...
namespace TaparApi.Common.Api
{
    public class ApiResult
    {
        ...
        public static implicit operator ApiResult(UnprocessableEntityObjectResult result)
        {
    ...
    public class ApiResult<TData> : ApiResult
        where TData : class
    {
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]//yani age null bashad dar khoruji emal nashavad
        ...
        {
            return new ApiResult<TData>(false, ApiResultStatusCode.NotFound, null, result.Value.ToString());
        }
        #endregion
    }
}
